...
def deccode_output_score_and_ptss(tpMap, topk_n = 25, ksize = 5):
    '''
    tpMap:
    center: tpMap[1, 0, :, :]
...
# def deccode_lines(tpMap,score_thr=0.1, dist_thr= 20, topk_n = 200, ksize = 11):
...
def deccode_lines(tpMap,  score_thresh = 0.1, len_thresh=2, topk_n = 25, ksize = 5):
    '''
    tpMap:
    center: tpMap[1, 0, :, :]
    displacement: tpMap[1, 1:5, :, :]
